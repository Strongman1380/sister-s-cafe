// Enhanced Cart Management with EmailJS Integration
function renderMenu() {
  ...
  menuData.forEach(section => {
      ...
      section.items.forEach(item => {
          ...
          li.innerHTML = `
              ...
              <button class="btn-add-to-cart" data-name="${item.name}" data-price="${item.price}">Add</button>
          `;
          ul.appendChild(li);
      });
